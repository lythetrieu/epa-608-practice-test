...
// Approved skin (see _docs/app-homepage-skin-mockup.html):
// Fraunces = screen titles + hero moments ONLY; JetBrains Mono = big stat numbers.
...
export const viewport: Viewport = { themeColor: '#003087', viewportFit: 'cover' }
