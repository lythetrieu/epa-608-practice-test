...
const PLANS: PlanCardData[] = [
  {
    ...
    price: '$0',
    priceNote: 'forever',
    description: 'Get started with Core category questions — no credit card required.',
    features: [
      { text: 'Core category only', included: true },
      { text: '10 questions per day', included: true },
      { text: 'Instant pass/fail feedback', included: true },
      { text: 'All 4 categories (I, II, III)', included: false },
      { text: 'Answer explanations', included: false },
      { text: 'Progress tracking & analytics', included: false },
      { text: 'Blind-spot training', included: false },
      { text: 'PDF study guide', included: false },
