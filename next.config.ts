        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co http://127.0.0.1:54321 https://openrouter.ai https://sandbox-api.paddle.com https://api.paddle.com https://*.paypal.com https://*.paypalobjects.com https://www.google-analytics.com https://analytics.google.com https://polar.sh https://*.polar.sh https://api.polar.sh",
              "frame-src https://sandbox-buy.paddle.com https://buy.paddle.com https://*.paypal.com https://buy.polar.sh https://polar.sh https://*.polar.sh",
            ].join('; '),
          },
        ],
      },
